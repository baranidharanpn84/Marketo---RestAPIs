...
export_file = 'C:/Talend/JobFiles/Marketo/Export/Lead/file_mkto_lead_first_500k.csv' # Put a path as per your  directory. New file created and will have email, ID, status columns
batch_size = 300
...
if __name__ == "__main__":
    a = 0
    b = 0
    for leads in mc.execute(method='get_multiple_leads_by_list_id_yield', listId=76410, fields=[
        'id',
        'firstName',
        'middleName',
        'lastName',
