...
export_file = 'D:/Marketo/Export/Lead/file_mkto_lead.csv' # Put a path as per your  directory. New file created and will have email, ID, status columns
batch_size = 300

# SPECIFY CLIENT CREDENTIALS
munchkin_id ="347-IAT-677"
client_id = "fadff194-6e4f-4dec-a3fa-bf64b66e3d69"
client_secret = "a6TnnjDyiVWq6dtFAmabQOfZJcGkLmJW"
...
if __name__ == "__main__":
    a = 0
    b = 0
    for leads in mc.execute(method='get_multiple_leads_by_list_id_yield', listId=74840, fields=[
        'id',
        'firstName',
        'middleName',
        'lastName',
