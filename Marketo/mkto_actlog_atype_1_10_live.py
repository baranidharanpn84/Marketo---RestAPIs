...
export_file = 'C:/Talend/JobFiles/Marketo/Export/ActivityLog/ActivityLog_AType_1_10/file_mkto_actlog_atype_1_10_live.csv'
...
if __name__ == "__main__":
    a=0
    for activities in mc.execute(method='get_lead_activities_yield', activityTypeIds=['1','2','3','6','7','8','9','10','11','12'],
